...
(function() {
  ...
  async function renderHome() {
    ...
    try {
      ...
      app.innerHTML =
        '<div class="page">' +
          '<section class="hero">' +
            '<h1><span class="highlight">Participez a des giveaways premium</span><br>a partir de 1,80€</h1>' +
    ...
    try {
      ...
      app.innerHTML =
        '<div class="page container" style="padding:2rem 1rem">' +
          ...
          '<p class="section-subtitle">Participez pour seulement 1,80€</p>' +
          '<div class="card-grid">' +
        ...
        '<div class="page container detail-page">' +
          '<div class="detail-header">' +
            ...
            '<div class="detail-info">' +
              ...
              '</div>' +
              (!isFinished ? '<button class="btn btn-primary" onclick="window.showParticipateModal(' + g.id + ')">Participer - 1,80€</button>' :
          ...
          '<div class="detail-rules">' +
            ...
            '<ul>' +
              '<li>Participation unique pour 1,80€</li>' +
  ...
  window.showParticipateModal = function(giveawayId) {
    ...
    overlay.innerHTML =
      '<div class="modal">' +
        ...
        '<p style="font-size:0.85rem;color:var(--text-secondary);margin-top:0.5rem">Le paiement de 1,80€ sera active prochainement.</p>' +
  ...
  function renderHowItWorks() {
    ...
    const steps = [
      ...
      { num: '2', title: 'Valider sa participation', desc: 'Une participation coute 1,80€. Paiement securise. Vous ne pouvez participer qu\'une seule fois par giveaway.' },
  ...
  function renderFAQ() {
    ...
    const questions = [
      ...
      { q: 'Pourquoi seulement 1,80€ ?', a: 'Nous voulons que tout le monde puisse tenter sa chance. Le prix de 1,80€ couvre les frais de fonctionnement et permet d\'acheter les produits mis en jeu.' },
  ...
  function renderTerms() {
    ...
    app.innerHTML =
      '<div class="page container terms-page">' +
        ...
        '<p>Chaque participation est facturee 1,80€. Ce montant est non remboursable. Le tirage au sort est effectue de maniere aleatoire a la date de fin indiquee sur chaque giveaway.</p>' +
